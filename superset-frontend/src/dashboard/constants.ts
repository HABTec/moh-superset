...
export const FILTER_BAR_SHELL_PADDING = 12;
export const FILTER_BAR_SHELL_BORDER_WIDTH = 2;
export const FILTER_BAR_SHELL_WIDTH_OFFSET =
  FILTER_BAR_SHELL_PADDING * 2 + FILTER_BAR_SHELL_BORDER_WIDTH;
export const CLOSED_FILTER_BAR_SHELL_WIDTH =
  CLOSED_FILTER_BAR_WIDTH + FILTER_BAR_SHELL_WIDTH_OFFSET;
export const OPEN_FILTER_BAR_SHELL_WIDTH =
  OPEN_FILTER_BAR_WIDTH + FILTER_BAR_SHELL_WIDTH_OFFSET;
export const OPEN_FILTER_BAR_SHELL_MAX_WIDTH =
  OPEN_FILTER_BAR_MAX_WIDTH + FILTER_BAR_SHELL_WIDTH_OFFSET;
